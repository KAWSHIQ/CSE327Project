    ...
    <div class="row">
      <div class="col-md-12">
       ...
       <form action="#" method="POST" enctype = "multipart/form-data">
         ...
         <div style="margin-bottom:10px; display:inline-block; margin-left: 33%; color:#f7f7f7; background: #222; padding:10px 20px;" class="text-center">Registration Success <a href="view_students.php">View Students List Here</a> </div>
